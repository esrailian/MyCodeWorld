...
import com.esrailian.community.dao.LoginTicketMapper;
import com.esrailian.community.dao.UserMapper;
import com.esrailian.community.entity.LoginTicket;
...
import com.esrailian.community.util.MailClient;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds){
        ...
        loginTicket.setExpried(new Date(System.currentTimeMillis() + expiredSeconds * 1000));
